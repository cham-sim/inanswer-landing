              ...
              <>
                ...
                <label style={{ display: "flex", alignItems: "flex-start", gap: 10, cursor: "pointer", marginBottom: 8 }}>
                  <div
                    ...
                    style={{ width: 18, height: 18, borderRadius: 4, border: `1.5px solid ${errors.agreed ? "#FF6B6B" : agreed ? "#1B3A2D" : "rgba(168,176,192,0.4)"}`, background: agreed ? "#1B3A2D" : "transparent", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1, transition: "all 160ms" }}
                  >
                  ...
                  <span style={{ fontSize: 12, color: "var(--graphite)", lineHeight: 1.6 }}>
                    <span style={{ color: "var(--ink)", fontWeight: 500 }}>개인정보 수집·이용에 동의합니다.</span>{" "}
                    수집 항목: 로펌명, 담당자명, 연락처, 이메일 / 이용 목적: 상담 연락 / 보유 기간: 상담 완료 후 1년
                  </span>
                </label>
